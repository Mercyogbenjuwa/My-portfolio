...
export default function HomePage() {
  return <>
    <section className={styles.hero}>
      ...
      <div className={styles.portrait}><div className={styles.imageWrap}><Image src="/profile.png" alt="Mercy Ogbenjuwa" layout="fill" objectFit="cover" priority /></div><div className={styles.note}><span>Currently</span><strong>Leading Edge product development at Nathan Claire Africa</strong></div></div>
    </section>
    ...
    <section className={styles.snapshot}>
      ...
      <p>I lead discovery, research, roadmaps, requirements, product documentation, stakeholder alignment and delivery—then bring the engineering depth to understand architecture, APIs, data, quality, cloud and production. My experience spans loan platforms, PACS, CRM, trade-management systems, financial operations and enterprise applications.</p>
    </section>
